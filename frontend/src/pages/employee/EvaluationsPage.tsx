...
export default function EvaluationsPage() {
  ...
  const avgScore =
    filteredEvaluations.length > 0
      ...
      : '0.00';
  const latestEvaluation = filteredEvaluations[0];
    ...
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body2" color="text.secondary">
          عرض وتتبع تقييمات الأداء الخاصة بي
        </Typography>
      </Box>
          ...
          <Card>
            <CardContent>
              ...
              <Typography variant="h6" color="info.main">
                {latestEvaluation
                  ? getRatingLabel(latestEvaluation.finalRating)
                  : 'لا يوجد'}
              </Typography>
            </CardContent>
          </Card>
        ...
        <Card>
          <CardContent>
            <Box sx={{ textAlign: 'center', py: 6 }}>
              ...
              <Typography variant="body2" color="text.secondary">
                {!searchTerm && !statusFilter && !typeFilter
                  ? 'سيتم إنشاء التقييمات من قبل المدير المباشر'
